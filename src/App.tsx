...
function SettingsPage() { return <main className="data-page"><p className="eyebrow">설정 · 결제</p><h1>서비스 설정</h1><p className="data-page-copy">계정과 데이터 보관 정책이 연결되면 이 화면에서 관리할 수 있습니다.</p><div className="empty-state settings-empty"><h2>연결된 설정이 없습니다.</h2><p>현재 MVP에서는 인증, 결제, 데이터 삭제 API를 연결하지 않습니다.</p></div></main> }
